...
import { api, type MessageThreadItem } from '../services/api';
      ...
      <div className="flex justify-between items-center">
        ...
        {isStaff && (
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-primary text-white text-sm font-medium rounded-xl hover:opacity-90 shadow-md shadow-primary/20 transition-all active:scale-95"
          >
